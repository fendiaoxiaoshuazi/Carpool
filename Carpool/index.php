...
.left-bw3 h5, .middle-bw3 h5, .right-bw3 h5 {
    font-size: 2em;
    color: #000000;
    padding-bottom: 1em;
}
.left-bw3 h5 i, .middle-bw3 h5 i, .right-bw3 h5 i{
    padding-right: 10px;
}
.left-bw3 {
    float: left;
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<div id="home" class="w3ls-banner"> 
		...
		<div class="header-w3layouts"> 
			...
			<div class="row">
				<div class=".col-sm-3" style="background-color:#DFDFDF"><p>1</p></div>
			</div>			
		</div>	
		<!-- //header -->
	</div>	
...
<!--script src="/carpool/js/particles.js"></script-->
<!--script src="/carpool/js/app.js"></script-->
	
<!-- skills -->

<script src="/carpool/js/responsiveslides.min.js"></script>
			<script>
